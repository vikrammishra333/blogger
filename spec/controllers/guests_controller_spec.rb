  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested guest" do
        ...
        Guest.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => guest.to_param, :guest => {'these' => 'params'}}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the guest as @guest" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Guest.any_instance.stub(:save).and_return(false)
        put :update, {:id => guest.to_param, :guest => {}}, valid_session
        assigns(:guest).should eq(guest)
      end
